...
/* La portada lleva al menú normal ya configurado. */
(function setupCover20260721(){
  const cover=document.getElementById('coverOverlay');
  const button=document.getElementById('coverStartButton');
  ...
  button.addEventListener('touchend',event=>{event.preventDefault();openMenu()},{passive:false});
})();
